...
| 8. Aesthetic and minimalist design | Good: The site has a clear and easily navigatable design for surface level pages. <br /> Bad: A lot of the pages are hidden behind sub menus | Make it easier to find pages instead of submenus. | Make it easier to find pages instead of submenus.| 3 |
